...
class ArchRISCV32(Arch):
    ...
    bits = 32
    vex_arch = "VexArchRISCV64" # Valgrind doesn't have 32-bit
    name = "RISCV32"
    qemu_name = "riscv32"
    linux_name = "riscv32"
    ...
    uc_mode = _unicorn.UC_MODE_RISCV32 if _unicorn else None
    ...
    ld_linux_name = "ld-linux-riscv32-lp32d.so.1"
    elf_tls = TLSArchInfo(1, 32, [], [0], [], 0, 0)


register_arch([r".*riscv.*"], 32, Endness.ANY, ArchRISCV32)
